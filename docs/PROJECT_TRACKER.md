...
| **S15** Buyer portal | ack-user OTP login + buyer reads + self-ack (BE-15) | ⛔ | ✅ | ❌ | Await backend **BE-15 / WS-2·M2** — brief: [`BE15_BUYER_PORTAL_BRIEF.md`](BE15_BUYER_PORTAL_BRIEF.md) (ack-user passwordless login + buyer reads + self-ack; reuses the BE-18 substrate → `DL-BE-090`) | BE-15 / WS-2 |
...
5. **Deferred screens** — S9 (after M17), S15 (after **BE-15 / WS-2·M2** — brief `BE15_BUYER_PORTAL_BRIEF.md`, spec as M11-C, reuses BE-18).
